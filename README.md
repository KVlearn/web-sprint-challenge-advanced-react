...
1. Explain how to build stateful class components.
   We need the React.Component class from react.
   Then declare the constructor function as well as the super() method to carry the function from parent. And add the state variable in here. 
   Must to include the render method for constructor class component. 
   This render method should return the UI jsx elements. 
    
2. Describe the different phases of the component lifecycle.
React lifestyle phases are Mounting,  Updating, and  Unmounting.
Mounting - Render method is invoked and then the componentDidMount gets called
Updating - Is when we update the component data,setState is used to update
the data.ComponentDidUpdate gets called.
Unmounting - is the phase of removing the component from screen.
ComponentWillUnmount is called for any cleanup that is needed.

3. Demonstrate an understanding of class component lifecycle methods.
Mounting Phase - has the constructo call and the Render Phase.No sideeffects here.Commits to virtual DOM and mounting happens. ComponentDidMount is called after the initial render is complete.

Updating phase - the state is udpdated, and accordingly render happends as well. componentDidUpdate gets called to handle change is data.

Unmounting phase is to remove the component and clean up is performed in componentwillUnmount method.

4. Define stateful logic.
    Logic involving the use of state and setState, typically any handle events and updating of state.(except for the render of DOM elements, typically most of the logic involves in stateful logic)

5. Describe how to test a React component with React Testing Library.
 This involves testing components via dom nodes.Import the react library,and perform the Arrange,Act and Assert functions to validate the expected node element is rendered on the screen/dom.
...
- [x] Add a filter input to the plant list page. 
